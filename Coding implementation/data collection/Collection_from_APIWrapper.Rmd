...
df_filtered <- df_Brexit %>% filter(str_detect(comment, regex("Brexit", ignore_case = TRUE)));dim(filtered); summary(filtered)
dim(df_filtered); summary(df_filtered); dim(df_Brexit); summary(df_Brexit)
```
