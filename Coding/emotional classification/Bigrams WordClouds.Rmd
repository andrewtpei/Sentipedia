```{r}
library(RedditExtractoR);library(tidyverse);library(tidytext); library(wordcloud2); library(textdata); library(gridExtra); library(gridGraphics); library(ggplotify); library(plotly)
```
